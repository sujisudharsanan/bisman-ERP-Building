...
CREATE TABLE IF NOT EXISTS support_tickets (
    ...
    category VARCHAR(50) NOT NULL CHECK (category IN ('login_access', 'data_mismatch', 'payment_billing', 'approvals_workflow', 'mattermost_chatbot', 'calendar_scheduling', 'erp_performance', 'request_feature', 'others')),
