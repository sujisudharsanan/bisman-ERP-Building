...
export default function FinanceControllerDashboardPage() {
  const { user, loading: authLoading } = useAuth();
  const router = useRouter();
  
  const { dashboardData, loading: dataLoading } = useDashboardData(user?.roleName || 'FINANCE_CONTROLLER');
  ...
  return (
    <DashboardLayout role={user.roleName || 'FINANCE_CONTROLLER'}>
