...
export default function SystemSettingsLimited() {
  ...
  return (
    <SuperAdminLayout
      ...
      description="View system settings (limited access)"
    >
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">View system settings (limited access)</p>
          </div>
