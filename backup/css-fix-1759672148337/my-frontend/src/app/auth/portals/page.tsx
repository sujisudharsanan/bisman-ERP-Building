  ...
  const portals = [
    {
      ...
      color: 'blue',
      features: ['User Management', 'System Settings', 'Security Controls', 'Reports']
    },
    {
      ...
      color: 'green',
      features: ['Staff Management', 'Sales Reports', 'Inventory Oversight', 'Analytics']
    },
    {
      ...
      color: 'orange',
      features: ['Fuel Tank Monitoring', 'Pump Operations', 'Daily Reports', 'Stock Alerts']
    },
    {
      title: 'General Login',
      ...
      href: '/auth/login',
      color: 'gray',
      features: ['Basic Access', 'Role-based Dashboard', 'Standard Features', 'User Functions']
    }
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 flex flex-col items-center justify-center px-4 py-8">
      <div className="w-full max-w-6xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-blue-200 mb-2">Enterprise Resource Planning System</p>
            ...
            return (
              ...
              >
                <div className="text-center">
                  <div className={`w-16 h-16 ${colors.bg} rounded-full mx-auto mb-4 flex items-center justify-center group-hover:scale-110 transition-transform`}>
                  ...
                  <div className={`inline-flex items-center ${colors.text} font-medium group-hover:gap-3 gap-2 transition-all`}>
                    Access Portal
