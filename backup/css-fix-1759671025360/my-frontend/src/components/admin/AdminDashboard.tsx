...
function renderTabContent(tab: string, searchTerm: string, filterModule: string) {
  switch (tab) {
    case 'roles':
    ...
    case 'permissions': {
      const PermissionsComp = PermissionsManagement as unknown as React.ComponentType<{ searchTerm: string }>
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Configure system-wide RBAC settings</p>
      </div>
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <div className="space-y-6">
            {/* Permission Caching */}
            <div>
              <h4 className="text-base font-medium text-gray-900">Permission Caching</h4>
              <p className="text-sm text-gray-500 mt-1">
                Control how permissions are cached to improve performance
              </p>
              <div className="mt-3 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-700">Enable permission caching</span>
                  <input
                    type="checkbox"
                    defaultChecked
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-700">Cache duration (minutes)</span>
                  <input
                    type="number"
                    defaultValue={15}
            ...
            <div className="border-t pt-6">
              <h4 className="text-base font-medium text-gray-900">Audit Logging</h4>
              <p className="text-sm text-gray-500 mt-1">
              ...
              <div className="mt-3 space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-700">Log retention (days)</span>
                  <input
                    type="number"
                    defaultValue={90}
                    className="w-20 px-2 py-1 border border-gray-300 rounded-md text-sm"
            ...
            <div className="border-t pt-6">
              ...
              <div className="mt-3 space-y-3">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-700">Require 2FA for admin actions</span>
                  <input
                    type="checkbox"
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded"
                  />
