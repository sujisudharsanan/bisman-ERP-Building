...
export const PAGE_REGISTRY: PageMetadata[] = [
  ...
  {
    id: 'enterprise-admin-subscription',
    name: 'Subscription Overview',
    path: '/enterprise-admin/subscription',
    iconKey: "CreditCard",
    module: 'enterprise-admin',
    permissions: ['enterprise-admin'],
    roles: ['ENTERPRISE_ADMIN'],
    status: 'active',
    showInSidebar: true,
    description: 'Master control panel for subscription plans, features, and billing',
    order: 3.6,
  },
  {
  ...
  iconKey: "Activity",
    module: 'system',
    permissions: ['system-settings'],
  roles: ['SUPER_ADMIN', 'SYSTEM_ADMIN', 'IT_ADMIN'],
    status: 'active',
    description: 'Monitor system performance and health',
    order: 8,
  },
  ...
  iconKey: "BookOpen",
    module: 'finance',
    permissions: ['executive-dashboard'],
    roles: ['CFO', 'FINANCE_CONTROLLER', 'ACCOUNTS'],
    status: 'active',
  ...
  iconKey: "FileText",
    module: 'finance',
    permissions: ['executive-dashboard'],
    roles: ['ACCOUNTS', 'ACCOUNTS_PAYABLE'],
    status: 'active',
  ...
  iconKey: "FileEdit",
    module: 'finance',
    permissions: ['executive-dashboard'],
    roles: ['FINANCE_CONTROLLER', 'ACCOUNTS'],
    status: 'active',
  ...
  iconKey: "Receipt",
    module: 'finance',
    permissions: ['executive-dashboard'],
    roles: ['ACCOUNTS_PAYABLE', 'ACCOUNTS'],
    status: 'active',
  ...
  iconKey: "Users",
    module: 'finance',
    permissions: ['executive-dashboard'],
    roles: ['ACCOUNTS_PAYABLE', 'PROCUREMENT_OFFICER'],
    status: 'active',
  ...
  iconKey: "Boxes",
    module: 'finance',
    permissions: ['executive-dashboard'],
    roles: ['TREASURY', 'BANKER', 'ACCOUNTS_PAYABLE'],
    status: 'active',
  ...
  iconKey: "CheckCircle",
    module: 'finance',
    permissions: ['executive-dashboard'],
    roles: ['CFO', 'TREASURY', 'FINANCE_CONTROLLER'],
    status: 'inactive',
  ...
  iconKey: "FileText",
    module: 'procurement',
    permissions: ['purchase-order'],
    roles: ['PROCUREMENT_OFFICER', 'STORE_INCHARGE'],
    status: 'active',
  ...
  iconKey: "Package",
    module: 'procurement',
    permissions: ['purchase-order'],
    roles: ['PROCUREMENT_OFFICER', 'STORE_INCHARGE', 'OPERATIONS_MANAGER'],
    status: 'active',
  ...
  iconKey: "Package",
    ...
    roles: ['STORE_INCHARGE', 'HUB_INCHARGE', 'OPERATIONS_MANAGER'],
    status: 'active',
  ...
  iconKey: "Tag",
    module: 'operations',
    permissions: ['inventory-management'],
    roles: ['STORE_INCHARGE', 'OPERATIONS_MANAGER'],
    status: 'active',
  ...
  iconKey: "Factory",
    module: 'operations',
    permissions: ['inventory-management'],
    roles: ['OPERATIONS_MANAGER', 'HUB_INCHARGE'],
    status: 'active',
  ...
  iconKey: "ListChecks",
    module: 'operations',
    permissions: ['inventory-management'],
    roles: ['OPERATIONS_MANAGER', 'STORE_INCHARGE'],
    status: 'active',
  ...
  iconKey: "MapPin",
    module: 'operations',
    permissions: ['inventory-management'],
    roles: ['STORE_INCHARGE', 'HUB_INCHARGE'],
    status: 'active',
  ...
  // NOTE: Branch Dashboard removed - uses main /dashboard page
  // Branch Incharge role added to main dashboard entry instead
  {
    ...
    module: 'common',
    permissions: ['authenticated'],
    roles: ['BRANCH_INCHARGE', 'HUB_INCHARGE', 'STORE_INCHARGE', 'ADMIN', 'MANAGER'],
    status: 'active',
  ...
  },
  {
    ...
    module: 'common',
    permissions: ['authenticated'],
    roles: ['ALL', 'ADMIN', 'SUPER_ADMIN', 'BRANCH_INCHARGE'],
    status: 'active',
  ...
  // These pages use the (dashboard) Next.js route group for shared layout
  {
    ...
    module: 'operations',
    permissions: ['inventory-management'],
    roles: ['STORE_INCHARGE', 'HUB_INCHARGE', 'OPERATIONS_MANAGER', 'ADMIN'],
    status: 'active',
  ...
  },
  {
    ...
    module: 'operations',
    permissions: ['inventory-management'],
    roles: ['STORE_INCHARGE', 'OPERATIONS_MANAGER', 'ADMIN'],
    status: 'active',
  ...
  },
  {
    ...
    module: 'operations',
    permissions: ['inventory-management'],
    roles: ['STORE_INCHARGE', 'HUB_INCHARGE', 'OPERATIONS_MANAGER', 'ADMIN', 'CFO', 'FINANCE_CONTROLLER'],
    status: 'active',
  ...
  },
  {
    ...
    module: 'operations',
    permissions: ['inventory-management'],
    roles: ['OPERATIONS_MANAGER', 'ADMIN', 'CFO'],
    status: 'active',
  ...
  },
  {
    ...
    module: 'operations',
    permissions: ['inventory-management'],
    roles: ['HUB_INCHARGE', 'OPERATIONS_MANAGER', 'ADMIN'],
    status: 'active',
  ...
  },
  {
    ...
    module: 'operations',
    permissions: ['inventory-management'],
    roles: ['HUB_INCHARGE', 'STORE_INCHARGE', 'OPERATIONS_MANAGER', 'ADMIN'],
    status: 'active',
  ...
  },
  {
    ...
    module: 'operations',
    permissions: ['inventory-management'],
    roles: ['OPERATIONS_MANAGER', 'CFO', 'ADMIN'],
    status: 'inactive',
  ...
  // Additional Procurement Pages
  {
    ...
    module: 'procurement',
    permissions: ['purchase-order'],
    roles: ['PROCUREMENT_OFFICER', 'STORE_INCHARGE', 'ADMIN'],
    status: 'active',
  ...
  },
  {
    ...
    status: 'active',
    showInSidebar: true,
    description: 'Master subscription control panel - plan management, feature limits, pricing',
    order: 11,
  },
  {
