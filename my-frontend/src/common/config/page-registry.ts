...
export interface PageMetadata {
  ...
  iconKey?: string;
  module: 'system' | 'finance' | 'procurement' | 'operations' | 'compliance' | 'common' | 'pump-management' | 'hr' | 'super-admin' | 'enterprise-admin' | 'admin';
...
export const PAGE_REGISTRY: PageMetadata[] = [
  ...
  },
  {
    ...
    roles: ['SUPER_ADMIN'],
    status: 'active',
    description: 'View all pages and their assigned roles',
    order: 5,
  },
  {
  ...
  },
  {
    id: 'fallback-logs',
    name: 'Fallback Logs',
    path: '/super-admin/fallback-logs',
    iconKey: "ShieldAlert",
    module: 'super-admin',
    permissions: ['system-settings'],
    roles: ['SUPER_ADMIN'],
    status: 'active',
    description: 'Monitor fallback events, errors, and system alerts',
    order: 11,
  },
