...
export const PAGE_REGISTRY: PageMetadata[] = [
  ...
  },
  {
    ...
    module: 'common',
    permissions: ['authenticated'],
    roles: ['BRANCH INCHARGE', 'BRANCH_INCHARGE', 'HUB INCHARGE', 'HUB_INCHARGE', 'STORE INCHARGE', 'STORE_INCHARGE', 'STAFF', 'USER'],
    status: 'active',
    description: 'Team messaging and communication',
    order: 20,
  },
  {
    id: 'branch-ai-assistant',
    name: 'AI Assistant',
    path: '/chat/ai',
    iconKey: "Bot",
    module: 'common',
    ...
    roles: ['BRANCH INCHARGE', 'BRANCH_INCHARGE', 'HUB INCHARGE', 'HUB_INCHARGE', 'STORE INCHARGE', 'STORE_INCHARGE', 'STAFF', 'USER'],
    status: 'active',
    description: 'AI-powered assistant for help and queries',
    order: 21,
  },
  {
