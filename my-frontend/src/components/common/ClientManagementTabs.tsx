...
export default function ClientManagementTabs() {
  ...
  return (
    <div className="mb-6">
      {/* Header */}
      <div className="mb-4">
        <h1 className="text-2xl font-semibold dark:text-white">Client Management</h1>
        <p className="text-gray-500 dark:text-gray-400">Manage clients, permissions and module assignments</p>
      </div>
