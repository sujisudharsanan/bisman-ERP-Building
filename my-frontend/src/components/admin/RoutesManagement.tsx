...
export default function RoutesManagement({
  ...
  const [showDeleteConfirm, setShowDeleteConfirm] = useState<RouteType | null>(
    null
  );
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-gray-500">
            Manage API routes and access controls
          </p>
        </div>
        <button
      ...
      <div className="space-y-6">
        {Object.entries(groupedRoutes).map(
          ([module, moduleRoutes]: [string, any]) => (
            <div
              key={module}
            ...
            >
              <div className="px-4 py-5 sm:px-6 bg-gray-50">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  {moduleRoutes.length} route
                  {moduleRoutes.length !== 1 ? 's' : ''}
                </p>
              </div>
                  ...
                  {moduleRoutes.map((route: RouteType, index: number) => (
                    ...
                    >
                      <div className="text-sm font-medium text-gray-900 space-y-2">
                        ...
                        <div className="flex items-center space-x-2">
                          <span
                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getMethodBadgeColor(route.method)}`}
                          >
                            {route.method}
                          </span>
                          {route.isProtected ? (
      ...
      <div className="bg-white rounded-lg shadow-lg max-w-md w-full">
        <div className="p-6">
          ...
          <p className="text-sm text-gray-500 mb-4">
            ...
            <strong>{route.path}</strong>? This action cannot be undone and may
