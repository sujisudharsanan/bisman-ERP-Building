...
export default function KPIDashboardPage() {
  ...
  const { dashboardData, loading: dataLoading } = useDashboardData(user?.roleName || 'OPERATIONS_MANAGER');
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">Loading Operations Dashboard...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <DashboardLayout role={user.roleName || 'OPERATIONS_MANAGER'}>
