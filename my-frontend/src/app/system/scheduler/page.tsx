...
export default function SchedulerPage() {
  ...
  return (
    <SuperAdminShell title="Scheduler">
            ...
            <div>
              ...
              <div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li>Connect to backend API endpoint: <code className="bg-blue-100 dark:bg-blue-900 px-1 rounded">/api/system/scheduler</code></li>
