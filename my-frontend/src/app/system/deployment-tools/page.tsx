...
export default function DeploymentToolsPage() {
  const [data, setData] = useState<DeploymentToolsData[]>([]);
  ...
  const fetchData = async () => {
    try {
      ...
      // const response = await fetch('/api/system/deployment-tools');
  ...
  return (
    <SuperAdminShell title="Deployment Tools">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
              Manage and monitor deployment tools
            </p>
          </div>
            ...
            <div>
              ...
              <div className="mt-2 text-sm text-blue-700 dark:text-blue-300">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  <li>Connect to backend API endpoint: <code className="bg-blue-100 dark:bg-blue-900 px-1 rounded">/api/system/deployment-tools</code></li>
