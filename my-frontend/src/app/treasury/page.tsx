...
export default function TreasuryDashboardPage() {
  ...
  const { dashboardData, loading: dataLoading } = useDashboardData(user?.roleName || 'TREASURY');
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-900 via-emerald-900/20 to-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-white text-lg">Loading Treasury Dashboard...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <DashboardLayout role={user.roleName || 'TREASURY'}>
