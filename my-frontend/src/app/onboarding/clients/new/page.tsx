        ...
        {currentKey === 'compliance' && (
          <section className="space-y-4" aria-labelledby="compliance">
            ...
            <div className="grid md:grid-cols-4 gap-4 text-xs">
              ...
              <FormField label="Risk Score" tooltip="0-100"><input type="number" min={0} max={100} value={state.compliance.risk_score ?? ''} onChange={e=>update('compliance',{...state.compliance, risk_score: e.target.value === '' ? 0 : parseInt(e.target.value,10)})} className="border rounded p-2 w-full dark:bg-gray-700 dark:text-white dark:border-gray-600" /></FormField>
