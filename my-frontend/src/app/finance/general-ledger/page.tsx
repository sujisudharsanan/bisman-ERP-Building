...
export default function GeneralLedgerPage() {
  ...
  const { dashboardData, loading: dataLoading } = useDashboardData(user?.roleName || 'ACCOUNTS');
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 text-sm">Loading General Ledger...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <DashboardLayout role={user.roleName || 'ACCOUNTS'}>
