...
import { Search, RefreshCw, ChevronRight, Clock, AlertTriangle, CheckCircle, XCircle, Filter, FileCheck } from 'lucide-react';
...
export default function AdminTaskApprovalsPage() {
  ...
  const handleTaskClick = (taskId: string) => {
    router.push(`/admin/task-approvals/${taskId}`);
  };
    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500"
        />
      </div>
      ...
      {/* Quick Link to System Flow */}
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-4">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-gray-100">Need to understand the approval hierarchy?</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">View the complete role structure and workflow paths</p>
          </div>
          <Link
