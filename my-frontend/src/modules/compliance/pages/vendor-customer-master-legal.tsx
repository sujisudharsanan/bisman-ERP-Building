...
export default function VendorCustomerMasterLegal() {
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400">Manage legal entity data</p>
          </div>
