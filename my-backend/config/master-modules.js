...
const MASTER_MODULES = [
  {
    ...
    pages: [
      ...
      { id: 'super-admin-about-me', name: 'About Me', path: '/super-admin/system/about-me' },
      { id: 'fallback-recovery', name: 'Fallback & Recovery', path: '/super-admin/system/fallback-recovery' },
      ...
      { id: 'super-admin-system-index', name: 'System Overview', path: '/super-admin/system' },
  ...
  },
  {
    ...
    pages: [
      ...
      { id: 'pages-roles-report', name: 'Pages & Roles Report', path: '/system/pages-roles-report' },
      ...
      { id: 'deployment-tools', name: 'Deployment Tools', path: '/system/deployment-tools' },
  ...
  },
  {
    ...
    pages: [
      ...
      { id: 'common-hr-policy', name: 'HR Policy', path: '/common/hr-policy' },
      ...
      { id: 'dashboard-requests', name: 'Requests', path: '/dashboard/requests' },
