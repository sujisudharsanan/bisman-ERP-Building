...
const fsPages = [
  ...
  '/chat/ai','/common/about-me','/common/bank-accounts','/common/calendar',
  ...
  '/enterprise-admin/monitoring','/enterprise-admin/monitoring/database',
  ...
  '/enterprise-admin/super-admins','/enterprise-admin/super-admins/create',
  '/enterprise-admin/users','/finance-controller',
  ...
  '/system/backup-restore','/system/company-setup',
  '/system/integration-settings','/system/master-data-management',
  '/system/permission-manager',
  '/system/roles-users-report','/system/scheduler',
