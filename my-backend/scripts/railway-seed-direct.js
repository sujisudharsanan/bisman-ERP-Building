...
const PAGES = [
  ...
  { page_code: 'ENTERPRISE_ADMIN_SETTINGS', display_name: 'Enterprise Settings', route: '/enterprise-admin/settings', module_code: 'ENTERPRISE_ADMIN', icon: 'Settings', sort_order: 5, roles: ['ENTERPRISE_ADMIN'] },
  { page_code: 'ENTERPRISE_ADMIN_BILLING', display_name: 'Billing & Subscription', route: '/enterprise-admin/billing', module_code: 'ENTERPRISE_ADMIN', icon: 'CreditCard', sort_order: 6, roles: ['ENTERPRISE_ADMIN'] },
