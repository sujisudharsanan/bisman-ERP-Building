 ...
 * Usage: node delete-users-by-email.js --confirm
 */
...
async function deleteUsers() {
  ...
  try {
    console.log('\n========================================');
    console.log('DELETE USERS BY EMAIL');
    console.log('========================================\n');
    ...
    if (!process.argv.includes('--confirm')) {
      ...
      console.log('  node delete-users-by-email.js --confirm\n');
    ...
    for (const user of users) {
      ...
      if (userPermissions.length > 0) {
        ...
        console.log(`✅ Deleted ${userPermissions.length} permissions for user ${user.email}`);
      }
      // Delete the user
