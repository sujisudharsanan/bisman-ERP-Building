-- Fix the ambiguous column reference in enhanced_audit_trigger_func
-- The 'key' column was ambiguous when doing ARRAY_AGG(key) - now qualified as new_kv.key
...
BEGIN
    ...
    ELSIF TG_OP = 'UPDATE' THEN
        ...
        -- FIX: Qualify 'key' column reference to avoid ambiguity
