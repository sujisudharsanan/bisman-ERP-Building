-- Migration: Task Management System with Approval Hierarchy
-- Date: 2025-11-25
-- Description: Creates tables for integrated task-chat system
...
-- ============================================
-- 4. TASK PARTICIPANTS TABLE (Additional participants beyond creator/assignee)
-- ============================================
...
-- ============================================
-- 5. TASK HISTORY TABLE (Audit trail)
-- ============================================
...
-- ============================================
-- 6. TASK DEPENDENCIES TABLE (Task relationships)
-- ============================================
...
-- ============================================
-- 7. TASK TEMPLATES TABLE (Reusable task templates)
-- ============================================
...
-- Active tasks with user details
...
-- Task dashboard summary by user
...
-- Example: INSERT INTO task_templates ...

COMMENT ON TABLE tasks IS 'Main tasks table with approval hierarchy support';
