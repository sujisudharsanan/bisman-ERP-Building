...
VALUES ('baseline-20251124', '', now(), '20251201_0000_baseline_init', NULL, NULL, now(), 1)
ON CONFLICT (migration_name) DO NOTHING;

-- Mark failed legacy migration as rolled back
UPDATE _prisma_migrations SET rolled_back_at = now() WHERE migration_name = '20250926_add_roles_table' AND rolled_back_at IS NULL;
